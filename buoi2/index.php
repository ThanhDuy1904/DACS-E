...
require_once 'app/controllers/DashboardDiscountController.php';
require_once 'app/controllers/DashboardUserController.php';
require_once 'app/controllers/DashboardOrderController.php';

// Include DashboardProductController
if (file_exists('app/controllers/DashboardProductController.php')) {
    require_once 'app/controllers/DashboardProductController.php';
}

// Initialize controller and action variables
$controller = isset($url[0]) && $url[0] != '' ? ucfirst($url[0]) : '';
$action = isset($url[1]) && $url[1] != '' ? $url[1] : 'index';

// Handle ProductDashboard routes
if ($controller === 'ProductDashboard') {
    require_once 'app/controllers/ProductDashboardController.php';
    $controllerInstance = new ProductDashboardController();
    ...
    switch ($action) {
        case 'index':
            ...
            break;
        case 'getStatsApi':
            $controllerInstance->getProductStatsApi();
            break;
        default:
            $controllerInstance->index();
            break;
