...
class ProductApiController
{
    ...
    public function update($id)
    {
        ...
        try {
            ...
            // Chỉ cập nhật các trường được gửi lên, giữ nguyên giá trị cũ cho các trường không có
    ...
    // Helper method để clean output buffer
    ...
    // Helper method để gửi JSON response an toàn
    private function sendJsonResponse($data, $statusCode = 200) {
        // Clean output buffer trước khi gửi response
        $this->cleanOutput();
        ...
        try {
            ...
            $jsonData = json_encode([
                'error' => true,
                'message' => 'Lỗi encode JSON: ' . $e->getMessage(),
                'debug_info' => [
