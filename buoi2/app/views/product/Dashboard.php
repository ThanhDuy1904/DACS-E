...
<body>
    ...
    <div class="container-fluid">
        ...
        <div class="welcome-section">
            <div class="row align-items-center">
                <div class="col-md-8">
                    ...
                    <p class="mb-0 opacity-75">Thông tin tổng quan về sản phẩm trong hệ thống</p>
                </div>
        ...
        <!-- Low Stock Products (if available) -->
                                            ...
                                            <div class="d-flex align-items-center">
                                                ...
                                                <?php if (!empty($imagePath)): ?>
                                                    ...
                                                    <div class="me-3 bg-light d-flex align-items-center justify-content-center" 
                                                         style="width: 40px; height: 40px; border-radius: 6px; display: none;">
                                                        <i class="fas fa-image text-muted"></i>
                                                    </div>
                                                <?php else: ?>
                                                    <div class="me-3 bg-light d-flex align-items-center justify-content-center" 
                                        ...
                                        <td>
                                            ...
                                            <?php else: ?>
                                                <span class="badge bg-warning">
                                                    <i class="fas fa-exclamation me-1"></i>Cảnh báo
                                                </span>
                                            <?php endif; ?>
                                        </td>
                                    </tr>
                    ...
                    <div class="row">
                        <div class="col-md-3 mb-3">
                            <div onclick="window.location.href='/buoi2/Product/add'" 
                                 ...
                                 style="background: linear-gradient(135deg, #667eea, #764ba2); color: white; cursor: pointer; border-radius: 15px; transition: all 0.3s ease;">
