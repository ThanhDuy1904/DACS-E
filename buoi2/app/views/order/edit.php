...
<head>
    <meta charset="UTF-8">
    <title>Cập nhật đơn hàng - Quản lý bán hàng</title>
...
<body>
    <div class="container">
        <h1>📝 Cập nhật đơn hàng #<?= htmlspecialchars($order['id']) ?></h1>
        ...
        <form id="order-form" method="POST">
            ...
            <!-- Danh sách sản phẩm -->
            <div class="form-section">
                <div class="section-title">🛍️ Danh sách sản phẩm</div>
            ...
            <div class="modal fade" id="productListModal" tabindex="-1" aria-labelledby="productListModalLabel" aria-hidden="true">
              <div class="modal-dialog modal-xl modal-dialog-scrollable">
                <div class="modal-content">
                  ...
                  <div class="modal-body" id="productListModalBody" style="min-height: 400px;">
                    <!-- Nội dung danh sách sản phẩm sẽ được load ở đây -->
            ...
            <!-- Nút hành động -->
            <div class="text-center">
                <button type="button" class="btn-save" onclick="saveOrder()">
                    💾 Lưu đơn hàng
                </button>
                <button type="button" class="btn-update" onclick="updateOrder()">
                    🔄 Cập nhật đơn hàng
                </button>
